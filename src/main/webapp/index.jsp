...
<html lang="en">
	...
	<body>
		...
		<!-- End: Header -->
        <div class="copyrights">Collect from <a href="http://www.17sucai.com/" >免费网站模板</a></div>
			...
			<div class="row">
				...
				<div id="footer">
					<ul>
						...
						<li>
							<div class="copyright">
								<p class="text-muted text-right">Fire <i class="fa fa-coffee"></i> Collect from <a href="http://www.17sucai.com/" title="网页模板" target="_blank">网页模板</a> - More Templates <a href="http://www.17sucai.com/" target="_blank" title="17素材网">17素材网</a></p>
							</div>
						</li>				
					</ul>	
				</div>
